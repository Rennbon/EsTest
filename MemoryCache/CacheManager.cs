...
namespace ESMemoryCache
{
    ...
    public static class CacheManager
    {
        ...
        private static readonly System.Collections.Concurrent.ConcurrentDictionary<string, ICache> Cachers;
        //两级缓存
        internal static readonly ICacheProvider[] Providers = new ICacheProvider[2];

        static CacheManager()
        {
            Cachers = new System.Collections.Concurrent.ConcurrentDictionary<string, ICache>();
        }
